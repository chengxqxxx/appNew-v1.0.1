  ...
  <div class="list-card">
    ...
    <div class="list-card-functionarea">
      ...
      <span class="col-sm-8" style="text-align:right">
        ...
        <button class="word-btn" style="top:-4px" @click="outtopdf">导出PDF</button>
        <button class="word-btn" style="top:-4px" @click="outtoexcel">导出Excel</button>
      </span>
    </div>
  ...
  methods: {
    ...
    outtoexcel() {
      if (this.selected.length > 0) {
        window.open(this.$ApiUrl + 'ordermanage/ordertoexcel?token=' + localStorage.getItem('token') + '&orderids=[' + this.selected + ']', '_blank');
      } else {
